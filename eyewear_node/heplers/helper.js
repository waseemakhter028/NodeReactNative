...
module.exports = {
  ...
  trans(key = "hello") {
    const data = fs.readFileSync(
      `${appRoot}/locales/${LOCALE}/translation.json`
    );
  ...
  sendException(res, message, status = 200) {
    if (process.env.NODE_ENV !== "production") message = message;
  ...
  sendPush(
    title = "title",
    body = "body",
    device_token = "evooy2mXFUCsSk60mSohrg:APA91bE1j75NGD-94jZC7vS2p84kaHxOhrrDI_8j2Sv7oSzF9DazJ7_LhBk7U6mezj5K3sbq2nW0GK-FeR4Up-wUB7kpPfog104O1mENFrkeiH0nBt4GIzTgEW-wRvcjGC5JQhZdnvvF"
  ) {
